...
const PopularToyCard = ({ toy }) => {
  const { pictureURL, subCategory, toyName, price, rating, availableQuantity } = toy;
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
      ...
      <div className="p-5">
        ...
        {/* Name */}
        <h2 className="text-lg font-semibold text-gray-800 mb-2 h-12 overflow-hidden">{toyName}</h2>
        ...
        <div className="space-y-2 text-gray-600 text-sm">
          ...
          <div className="flex items-center gap-2">
            <FaBoxOpen className="text-indigo-500" /> {availableQuantity} in stock
          </div>
        </div>
